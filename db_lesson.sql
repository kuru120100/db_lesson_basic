...
-- Q7
SELECT name FROM people WHERE (20<= age AND age < 30 and gender = 2) or (40<= age
and age < 50 and gender = 1);
...
-- Q11
SELECT p.name FROM people AS p LEFT JOIN reports AS r ON p.person_id = r.person_id WHERE r.content = '';
